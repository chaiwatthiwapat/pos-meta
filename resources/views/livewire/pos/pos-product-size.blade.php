    ...
    <div class="pt-3 px-4 border border-gray-200  border-blue-200 rounded-lg bg-blue-50">
        <div class="pb-3 flex gap-3 overflow-auto w-full">
            <label x-on:click="size.name = ''; size.price = 0" x-on:refresh-options.window="$el.click()" class="relative cursor-pointer">
                ...
                <div class="px-4 py-2 border border-gray-200  border-gray-300 rounded-lg bg-white shadow-xs text-gray-600 peer-checked:bg-blue-500 peer-checked:text-white peer-checked:border-blue-500 duration-200">
                    ปกติ
                </div>
            </label>
            ...
            @foreach($this->sizes() as $row)
                <label x-on:click="size.name = '{{ $row->name }}'; size.price = {{ $row->price }}" class="relative cursor-pointer">
                    ...
                    <div class="px-4 py-2 border border-gray-200  border-gray-300 rounded-lg bg-white shadow-xs text-gray-600 peer-checked:bg-blue-500
