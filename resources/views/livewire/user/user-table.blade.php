                    ...
                    <tr class="hover:bg-blue-50">
                        ...
                        <td class="px-5 py-3 border-b-2 border-blue-200 text-center text-xs font-semibold text-gray-700">
                            <div class="flex justify-end gap-1">
                                @if($row->id == 1 || $row->id == 2)
                                    <button class="bg-blue-500 text-white hover:bg-blue-600 duration-200  xxx px-4 py-3 h-10 xxx  rounded-lg font-medium text-xs opacity-50" disabled>
                                        แก้ไข
                                    </button>
                                    <button class="bg-red-500 text-white hover:bg-red-600 duration-200  xxx px-4 py-3 h-10 xxx  rounded-lg font-medium text-xs opacity-50" disabled>
                                        ลบ
                                    </button>
                                @else
